...
function CalendarioContent() {
  ...
  // Prevenir zoom em gestos de pinça em dispositivos móveis
  useEffect(() => {
    // Adicionar classe para prevenir zoom em gestos de pinça
    document.documentElement.classList.add('no-pinch-zoom');
    
    // Remover ao desmontar o componente
    return () => {
